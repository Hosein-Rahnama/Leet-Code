...
- You can sort the array which takes $\mathsf{O}(n \log n)$ time complexity. Now, you set two pointers to the beginning and end of the array and move them toward the middle.
